...
const DeveloperDashboard = () => {
    ...
    const fetchAllReviews = async () => {
        try {
            ...
            for (const app of apps) {
                ...
                if (response.success) {
                    allReviews.push(...response.reviews.map(r => ({ ...r, appTitle: app.title })));
                }
            }
            setReviews(allReviews.slice(0, 5)); // Get latest 5
        } catch (error) {
    ...
    const totalTesters = [...new Set(reviews.map(r => r.userId))].length;
            ...
            <main style={styles.mainContent}>
                ...
                <div style={styles.metricsGrid}>
                    ...
                    >
                        ...
                        <div style={styles.metricValue}>{reviews.length}</div>
